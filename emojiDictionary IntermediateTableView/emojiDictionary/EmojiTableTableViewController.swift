...
class EmojiTableTableViewController: UITableViewController {
    ...
    @IBSegueAction func addEditEmogi(_ coder: NSCoder, sender: Any?) -> AddEditTableViewController? {
    ...
    func unwindToEmojiTableView(_ segue: UIStoryboardSegue) {
        guard segue.identifier == "saveUnwind" else {
            return
        }
        guard let sourceVC = segue.source as? AddEditTableViewController, let emoji = sourceVC.emoji
        else {
            return
        }
